...
function rasporedApplyData(data, source) {
  ...
  // Ako stream već svira a ring nije startovan (npr. raspored stigao posle play-a), pokreni ga
  if (playing && typeof startRingForCurrentShow === 'function') startRingForCurrentShow();
}
...
/* ═══ PROGRESS RING ═══ */
// Ring funkcije su u ring.js — ringTimer, RING_CIRC, updateRing, clearRing, startRingForCurrentShow
